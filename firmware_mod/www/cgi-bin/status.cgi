                ...
                <div class="column">
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <input class="input" id="videouser" name="videouser" type="text" value="$(source /system/sdcard/config/rtspserver.conf; echo $USERNAME)" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <input class="input" id="videopassword" name="videopassword" type="password" value="$(source /system/sdcard/config/rtspserver.conf; echo $USERPASSWORD)" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <input class="input" id="videoport" name="videoport" type="number" placeholder="8554" value=$(source /system/sdcard/config/rtspserver.conf; echo $PORT) />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="field">
                                <div class="control">
                                    <div class="select">
                                        ...
                                        <option value="-W640 -H360"   $(source /system/sdcard/config/rtspserver.conf; if [ "$RTSPH264OPTS" == "-W640 -H360" ]; then echo selected; fi) >640 x 360</option>
                                        <option value="-W960 -H540"   $(source /system/sdcard/config/rtspserver.conf; if [ "$RTSPH264OPTS" == "-W960 -H540" ]; then echo selected; fi) >960 x 540</option>
                                        <option value="-W1280 -H720"  $(source /system/sdcard/config/rtspserver.conf; if [ "$RTSPH264OPTS" == "-W1280 -H720" ] || [ -z "$RTSPH264OPTS" ]; then echo selected; fi) >1280 x 720</option>
                                        <option value="-W1600 -H900"  $(source /system/sdcard/config/rtspserver.conf; if [ "$RTSPH264OPTS" == "-W1600 -H900" ]; then echo selected; fi) >1600 x 900</option>
                                        <option value="-W1920 -H1080" $(source /system/sdcard/config/rtspserver.conf; if [ "$RTSPH264OPTS" == "-W1920 -H1080" ]; then echo selected; fi) >1920 x 1080</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="field is-horizontal form-group">
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <input class="input" id="brbitrate" name="brbitrate" type="text" size="5" value="$(/system/sdcard/bin/setconf -g b)"/>
                                </div>
                            </div>
                        </div>
                        <div class="field-label is-normal">
                            <label class="label">kbps</label>
                        </div>
                    </div>
                    ...
                    <div class="field is-horizontal form-group">
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <input class="input" id="frmRateNum" name="frmRateNum" type="text" size="5" placeholder="25" value="$(source /system/sdcard/config/rtspserver.conf; echo $FRAMERATE_NUM)" placeholder="25"/>
                                </div>
                            </div>
                        </div>
                        <div class="field-label is-normal">
                            <label class="label">images per</label>
                        </div>
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <input class="input" id="frmRateDen" name="frmRateDen" type="text" size=5 placeholder="1" value="$(source /system/sdcard/config/rtspserver.conf; echo $FRAMERATE_DEN)"  placeholder="1" />
                                </div>
                            </div>
                        </div>
                        <div class="field-label is-normal">
